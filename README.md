...
The host board and phone controllers now use a unified 2.5D tabletop theme while preserving the original green, yellow, blue and red player colours. The dice is a physical six-face CSS cube. It tumbles along varied paths and always settles on the result generated by the authoritative server. Raised board tiles, recessed bases, dimensional tokens, buttons and panels use lightweight CSS/canvas effects rather than WebGL, keeping the game practical on televisions and phones.
